...
const MobileMenu = () =>{
  return (
    <div class="MobileMenu bg-white shadow-lg rounded-2xl fixed-bottom">
      <div class="flex">
        <div class="flex-1 group">
          <button class="flex items-end justify-center text-center mx-auto px-4 pt-2 w-full text-gray-400 group-hover:text-indigo-500">
