...
const Ads = () => {
  return (
    <div className="hidden sm:fixed sm:top-0 sm:right-0 sm:z-40 sm:w-64 sm:h-screen lg:block md:block sm:border-l sm:border-r sm:bg-gray-800 sm:border-gray-700 ">
