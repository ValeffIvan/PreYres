  ...
  return (
      <div className="h-full px-3 py-4 overflow-y-auto fixed top-0 left-0 z-40 w-96 hidden sm:fixed sm:h-screen lg:block md:block sm:bg-white sm:border-l sm:border-r dark:sm:bg-gray-800 dark:sm:border-gray-700">
        <ul className="space-y-2 font-medium">
          <li>
            <button className="flex items-center justify-center w-full p-2 rounded-lg hover:bg-gray-700 group">
              <svg
          ...
          <li>
            <button
              type="button"
              className="flex items-center justify-center w-full p-2 rounded-lg group hover:bg-gray-700"
