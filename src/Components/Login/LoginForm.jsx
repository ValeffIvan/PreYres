      ...
      <div className="p-6 space-y-4 md:space-y-6 sm:p-8">
        ...
        <form className="space-y-4 md:space-y-6" onSubmit={handleSubmit}>
          ...
          <div className="flex items-center justify-between">
            <div className="flex items-start">
              <div className="flex items-center h-5">
                <input id="remember" aria-describedby="remember" type="checkbox" className="w-4 h-4 border border-gray-300 rounded bg-gray-50 focus:ring-3 focus:ring-primary-300 bg-gray-700 border-gray-600 focus:ring-primary-600 ring-offset-gray-800"  />
              </div>
              <div className="ml-3 text-sm">
                <label htmlFor="remember" className="text-gray-500 text-gray-300">Recuerdame</label>
              </div>
            </div>
            <button className="text-sm font-medium text-right text-primary-600 hover:underline text-primary-500 text-white">Olvidé la contraseña</button>
          </div>
          ...
          <p className="text-sm font-light text-gray-500 text-gray-400 flex justify-center">
            <button className="font-medium text-primary-600 hover:underline text-primary-500" onClick={()=>{setLogin(false)}}>
