...
const Configuration = () => {
  return (
    <div className="sm:ml-96 sm:mr-64 justify-center h-screen dark:bg-gray-700">
      <div className="p-4 h-full flex flex-col">
        <h1 className="text-2xl font-bold mb-7 mt-5 text-black">
          <span className="inline-flex items-center">
            ...
            </svg><span className='text-gray-100'>Configuración</span>
          </span>
        </h1>
          <Tabs defaultActiveKey="profile" id="fill-tab-example" fill className='dark:sm:bg-gray-800 dark:sm:border-gray-700 hover:dark:sm:bg-gray-800 active:dark:sm:bg-gray-800 link:dark:sm:bg-gray-800 rounded-t-xl color-white' style={{ "--bs-nav-tabs-link-active-bg": "gray-700", "--bs-nav-tabs-border-width": "solid transparent", "--bs-nav-tabs-link-active-color": "white", "--bs-nav-link-color": "gray", "--bs-nav-link-hover-color": "gray" }}>
            <Tab eventKey="profile" title="Perfil" className='text-black bg-gray-100 h-full'>
              <ProfileConfig />
            </Tab>
            <Tab eventKey="account" title="Cuenta" className='text-black bg-gray-100 h-full'>
              <Account />
            </Tab>
            <Tab eventKey="bloqued" title="Bloqueados" className='text-black bg-gray-100 h-full'>
              <Bloqued />
            </Tab>
          </Tabs>
      </div>
